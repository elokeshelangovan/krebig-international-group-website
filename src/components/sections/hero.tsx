    ...
    >
      ...
      <Container size="lg" className="relative z-10">
        ...
        >
          <div className="flex flex-col items-start gap-6 text-left">
            <m.span
              variants={fadeInUp}
              className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold tracking-wide text-white uppercase backdrop-blur-sm"
            >
              {eyebrow}
            </m.span>
            ...
            <m.div variants={fadeInUp}>
              <Text variant="lead" className="max-w-xl text-pretty text-white/80">
                {description}
              </Text>
            </m.div>
      ...
      >
        ...
        <button
          ...
          className="focus-visible:ring-ring duration-fast flex flex-col items-center gap-2 rounded-full text-xs font-medium text-white/70 transition-colors hover:text-white focus-visible:ring-2 focus-visible:outline-none"
        >
          <span>Scroll</span>
          <m.svg
            viewBox="0 0 24 24"
